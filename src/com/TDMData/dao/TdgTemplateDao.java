...
public interface TdgTemplateDao{
	...
	/**
	 * By Sushil Birajdar
	 * This method is used to get parent or child constraint column names,table names,it's data type and
	 * length based on passed column names
	 * @param jdbcTemplate
	 * @param listcolumnsName
	 * @return
	...
	public List<String> getRelationTabs(String strUrl, String strUsername, String password,
			List<String> lstpassedTabs,String conditionParrentChield);
	...
	public String exportingDatabaseTable(DataConConnectionsDO dataConConnectionsDO, String listOfTables,String exportOnly);
}
