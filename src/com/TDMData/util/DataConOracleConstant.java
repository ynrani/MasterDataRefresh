...
public class DataConOracleConstant extends SepcQueryUtil
{
	...
	public static final String ORACLE_GET_DATE_COLUMNS_OF_TABLE = "select COLUMN_NAME from COLS WHERE TABLE_NAME='{0}' AND (DATA_TYPE LIKE 'TIMESTAMP' OR DATA_TYPE='DATE')";
	public static final String ORACLE_GET_COLS_TABS_SEQUENCE = "select Column_name,column_id from USER_TAB_COLUMNS where TABLE_NAME='{0}' ORDER BY COLUMN_ID";
	...
	//following code is used to fetch child tables
